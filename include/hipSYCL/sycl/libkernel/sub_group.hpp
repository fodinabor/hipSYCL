...
// Fixed sub-group size of the (hierarchical) CBS host compilation; must match
// hipsycl::compiler::SGSize in hipSYCL/compiler/cbs/IRUtils.hpp.
inline constexpr size_t SGSize = 32;
